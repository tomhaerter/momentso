...
async function start() {
  ...
  startTime.value = now
  activeStartTime.value = toTimeInputValue(now.toString())
  activeStartDate.value = formatDateInputValue(now.toString())
...
async function saveActiveStart() {
  ...
  const resetEditValue = (value: Temporal.Instant) => {
    ...
    activeStartTime.value = toTimeInputValue(value.toString())
    activeStartDate.value = formatDateInputValue(value.toString())
  }
